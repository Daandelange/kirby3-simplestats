(function() {
  "use strict";
  const SimpleStatsSectionBase_vue_vue_type_style_index_0_lang = "";
    ...
    methods: {
      ...
      async load(reload) {
        ...
        try {
          ...
          this.$store.dispatch("notification/error", (_a = error.message) != null ? _a : "Unknown error");
        } finally {
  ...
  __component__$e.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Sections/SimpleStatsSectionBase.vue";
  const SectionBase = __component__$e.exports;
  const SearchableTable_vue_vue_type_style_index_0_lang = "";
  const _sfc_main$d = {
    ...
    computed: {
      isSearchable() {
        if (false === (this.rows && this.rows.length >= 0))
          return false;
        if (false === (this.columns && Object.keys(this.columns).length >= 0))
          return false;
        return Object.values(this.columns).some((l) => l.search === true);
      },
      sortedFilteredRows() {
        return this.rows.filter((value, index2) => {
          var _a, _b;
          if (!((_a = this.searchterm) == null ? void 0 : _a.length))
            return true;
          for (const [colID, colAttrs] of Object.entries(this.columns)) {
            if (colAttrs.search === true) {
              if (typeof value[colID] === "object")
                continue;
          ...
          return (_b = value.slug) == null ? void 0 : _b.includes(this.searchterm);
        }).sort((a, b) => {
          if (this.sortBy === null)
            return 0;
  ...
  var _sfc_render$d = function render() {
    ...
    return _c("div", { staticClass: "ss-table" }, [_c("header", { staticClass: "k-section-header" }, [_c("k-headline", { attrs: { "size": "" } }, [_vm._v(" " + _vm._s(_vm.label) + " ")]), _c("k-button-group", { staticClass: "ss-table-buttons" }, [_vm.isSearchable ? _c("k-input", { staticClass: "k-models-section-search k-button", attrs: { "autofocus": false, "placeholder": _vm.$t("simplestats.table.filter", "Filter items \u2026"), "type": "text", "icon": "search" }, on: { "keydown": function($event) {
      if (!$event.type.indexOf("key") && _vm._k($event.keyCode, "esc", 27, $event.key, ["Esc", "Escape"]))
        return null;
      return _vm.cancelSearch.apply(null, arguments);
    } }, model: { value: _vm.searchterm, callback: function($$v) {
      _vm.searchterm = $$v;
    }, expression: "searchterm" } }) : _vm._e()], 1)], 1), _c("k-table", { attrs: { "columns": _vm.columns, "rows": _vm.sortedFilteredRows, "layout": "table", "sortable": false, "size": "tiny", "empty": _vm.searchterm && _vm.searchterm.length ? "No Search results..." : _vm.$t("simplestats.nodatayet") }, on: { "header": _vm.onHeaderClick } })], 1);
  };
  ...
  __component__$d.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Ui/SearchableTable.vue";
  const SearchableTable = __component__$d.exports;
  const Visitors_vue_vue_type_style_index_0_lang = "";
  const _sfc_main$c = {
    extends: SectionBase,
    data() {
      return {
  ...
  var _sfc_render$c = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("k-grid", [_c("k-column", [_c("k-headline", { attrs: { "size": "large" } }, [_vm._v(_vm._s(_vm.$t("simplestats.info.config.currentusers.title", "Visitors (current sessions)")))]), _c("searchable-table", { attrs: { "rows": _vm.rows, "columns": _vm.columns } }), _c("k-box", { attrs: { "theme": "info", "text": _vm.$t("simplestats.info.config.currentusers.info") } })], 1)], 1);
  };
  ...
  __component__$c.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Sections/Visitors.vue";
  const Visitors = __component__$c.exports;
  /*!
   * Chart.js v3.9.1
  ...
  function _longestText(ctx, font, arrayOfThings, cache) {
    ...
    for (i = 0; i < ilen; i++) {
      ...
      if (thing !== void 0 && thing !== null && isArray$1(thing) !== true) {
  ...
  function compareData(newData, oldData) {
    ...
    return oldData.datasets.length === newData.datasets.length && newDatasetLabels.every((value, index2) => value === oldDatasetLabels[index2]);
  }
  ...
  const _Merge = lodash_merge.exports;
  const AreaChart_vue_vue_type_style_index_0_lang = "";
  Chart.register(
    plugin_title,
    plugin_tooltip,
    plugin_legend,
  ...
  const _sfc_main$b = {
    name: "AreaChart",
    components: { LineChart: Line, BarChart: Bar, PieChart: Pie },
    inheritAttrs: false,
    props: {
      type: {
        type: String,
    ...
    computed: {
      ...
      hasDataForCurrentPeriod() {
        var _a;
        return !this.isEmpty && ((_a = this.chartData) == null ? void 0 : _a.some((dataset) => dataset.data && dataset.data.length >= 1));
      },
      fileDownloadStr() {
        var _a;
        const date = /* @__PURE__ */ new Date();
        return String((_a = this.download) != null ? _a : "MyChart.png").replace(".png", "-" + date.getFullYear() + "-" + Number(date.getMonth() + 1).toString().padStart(2, "0") + "-" + Number(date.getDate()).toString().padStart(2, "0") + ".png");
      },
      fullChartOptions() {
        var _a, _b;
        return _Merge(
          ...
          // Shared common styles
          {
            ...
            // To disable aspect ratio and allow setting height via CSS
            // animation: false,
            ...
            plugins: {
              legend: {
                maxHeight: 75
                // Limit legend height so charts don't become too tiny. Overflow is hidden.
              },
              filler: {
                propagate: true
                // Also fill when item below is hidden
              },
              interaction: {
          ...
          this.fill ? {
            fill: true,
            backgroundColor: typeof this.fill === "string" ? this.fill : "#313740"
            // same as Kirby's var(--color-dark)
          } : {},
          // Time axis
          this.xTimeAxis ? {
            scales: {
              xAxis: {
                title: {
                  display: false,
                  // Tick marks are explicit enough to understand that this is about time...
                  //display: true, // Show title
                  text: (_a = this.xTitle) != null ? _a : this.$t("simplestats.charts.time", "Time")
                  // Axis title
                },
                type: "time",
                time: {
          ...
          this.yVisitsAxis ? {
            scales: {
              yAxis: {
                title: {
                  display: true,
                  text: (_b = this.yTitle) != null ? _b : this.$t("simplestats.charts.visits", "Visits")
                },
                //type: 'logarithmic', // Show visits logarithmically = gives better details in small values
                beginAtZero: true
                // Force y axis to origin 0
              }
            }
          } : {},
          this.stacked ? {
      ...
      fullChartData() {
        const thisRef = this;
        const uidTree = this.chartData.map((dataset, i) => {
          var _a;
          return (_a = dataset.ss_uid) != null ? _a : i;
        });
        return {
          labels: this.chartLabels,
          datasets: this.chartData.map(function(dataset, i) {
            if ((thisRef.autoColorize || thisRef.autoGreyize) === true && // Option enabled
            ...
            !dataset.backgroundColor) {
              ...
              if (thisRef.type === "Pie") {
                ...
                for (let label of thisRef.chartLabels) {
                  dataset.backgroundColor.push(
                    thisRef.autoColorize ? "hsl(" + Number(360 / count * pos).toFixed(0) + "," + Number(saturation * 100).toFixed(0) + "%," + Number(lightness * 100).toFixed(0) + "%)" : "hsl(0,0%," + Number(40 + 40 / count * pos).toFixed(0) + "%)"
                  );
                  pos++;
                }
                return dataset;
              ...
              let hueThreshold = 0;
              let lumThreshold = 0;
              let parentImportance = 1;
              let siblings = null;
              parts.forEach((part, pi) => {
                if (!dataset.ss_uid) {
                  siblings = thisRef.chartData.map((value, key) => key);
                } else if (pi === 0) {
                  siblings = uidTree.filter((uid2) => String(uid2).includes("/") === false);
                } else {
                  siblings = uidTree.filter(function(uid2) {
                    const part2 = parts.slice(0, pi).join("/");
                    return String(uid2).startsWith(part2);
                  });
                }
                ...
                if (thisRef.autoColorize) {
                  if (pi === 0) {
                    hueThreshold = 1 / numSiblings * pos;
                  } else {
                    parentImportance /= numSiblings;
                    lumThreshold += parentImportance * 0.8 * pos;
                    if (pi > 1)
                      saturation -= 10;
                  }
                } else {
              ...
              dataset.backgroundColor = "hsl(" + Number(hueThreshold * 360).toFixed(0) + ", " + Number(saturation * 100 * (thisRef.autoGreyize ? 0 : 1)).toFixed(0) + "%, " + Number(lightness * 100 + lumThreshold * 50).toFixed(0) + "%)";
            }
            return dataset;
          })
        };
    ...
    methods: {
      generateDownloadLink() {
        ...
        if (this.download === false)
          return;
        if ((_a = this.$refs.linechart) == null ? void 0 : _a._data._chart) {
  ...
  var _sfc_render$b = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", [_vm.label.length > 0 ? _c("k-headline", { attrs: { "size": _vm.headerSize } }, [_vm._v(_vm._s(_vm.label))]) : _vm._e(), _c("div", { class: "ss-chart ss-" + _vm.type.toLowerCase() + "-chart" }, [_vm.download !== false && _vm.base64image.length ? _c("div", { staticClass: "ss-download-link" }, [_c("a", { attrs: { "href": _vm.base64image, "download": _vm.fileDownloadStr } }, [_c("k-button", { attrs: { "text": "Download", "tooltip": "Exports the chart as a PNG file that you can archive or share.", "icon": "download" } })], 1)]) : _vm._e(), _vm.hasDataForCurrentPeriod ? _c("div", { staticClass: "ss-chart-wrapper" }, [_c(_vm.type + "Chart", { ref: "linechart", tag: "component", attrs: { "chart-data": _vm.fullChartData, "chart-options": _vm.fullChartOptions, "height": _vm.height, "width": _vm.width } })], 1) : !_vm.isEmpty ? _c("k-empty", { staticClass: "emptyChart", attrs: { "layout": "block" } }, [_vm._v(_vm._s(_vm.$t("simplestats.nodatafortimerange", "There is no data for the selected time range.")))]) : _c("k-empty", { staticClass: "emptyChart", attrs: { "layout": "block" } }, [_vm._v(_vm._s(_vm.$t("simplestats.nodatayet", "No data yet")))])], 1)], 1);
  };
  ...
  __component__$b.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Ui/AreaChart.vue";
  const AreaChart = __component__$b.exports;
  const PageStats_vue_vue_type_style_index_0_lang = "";
  const _sfc_main$a = {
    extends: SectionBase,
    components: {
      SearchableTable,
    ...
    computed: {
      pageVisitsOverTimeDataSorted() {
        var _a;
        return (_a = this.pageVisitsOverTimeData) == null ? void 0 : _a.sort((a, b) => a.ss_uid < b.ss_uid ? -1 : a.ss_uid > b.ss_uid ? 1 : 0);
      }
    },
    methods: {
      loadData(apiResponse) {
  ...
  var _sfc_render$a = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("k-grid", { attrs: { "gutter": "medium" } }, [_c("k-column", [_c("k-headline", { attrs: { "size": "medium" } }, [_vm._v(_vm._s(_vm.$t("simplestats.visits.visitsovertime", "Visits over time")))]), _c("area-chart", { attrs: { "type": "Bar", "chart-data": _vm.visitsOverTimeData, "chart-options": _vm.chartOptions, "chart-labels": _vm.chartPeriodLabels, "download": "Site_Visits.png", "x-title": _vm.$t("simplestats.charts.time", "Time"), "y-title": _vm.$t("simplestats.charts.visits", "Visits"), "height": 100, "x-time-axis": true, "y-visits-axis": true, "show-legend": false, "fill": true } })], 1), _c("k-column", [_c("k-headline", { attrs: { "size": "medium" } }, [_vm._v(_vm._s(_vm.$t("simplestats.visits.pagevisitsovertime")))]), _c("area-chart", { attrs: { "chart-data": _vm.pageVisitsOverTimeDataSorted, "chart-labels": _vm.chartPeriodLabels, "chart-options": _vm.chartOptions, "download": "Site_PageVisits.png", "x-title": _vm.$t("simplestats.charts.time"), "y-title": _vm.$t("simplestats.charts.visits"), "height": 450, "stacked": true, "auto-colorize": true, "x-time-axis": true, "y-visits-axis": true, "fill": true } })], 1), _vm.languagesAreEnabled ? _c("k-column", { attrs: { "width": "3/4" } }, [_c("area-chart", { attrs: { "chart-data": _vm.languagesOverTimeData, "chart-labels": _vm.chartPeriodLabels, "chart-options": _vm.chartOptions, "download": "Site_LanguagesOverTime.png", "x-title": _vm.$t("simplestats.charts.time"), "y-title": _vm.$t("simplestats.charts.visits"), "height": 250, "stacked": true, "auto-colorize": true, "fill": true, "x-time-axis": true, "y-visits-axis": true, "label": _vm.$t("simplestats.visits.languagesovertime") } })], 1) : _vm._e(), _vm.languagesAreEnabled ? _c("k-column", { attrs: { "width": "1/4" } }, [_c("k-headline", [_vm._v(_vm._s(_vm.$t("simplestats.visits.globallanguages")))]), _vm.globalLanguagesData.length > 0 ? _c("area-chart", { attrs: { "type": "Pie", "download": "Site_LanguagePopularity.png", "chart-data": _vm.globalLanguagesData, "chart-labels": _vm.chartLanguagesLabels, "chart-options": _vm.chartOptions, "auto-colorize": true, "height": 200, "fill": true } }) : _vm._e()], 1) : _vm._e(), _c("k-column", [_c("searchable-table", { attrs: { "columns": _vm.columns, "rows": _vm.rows, "layout": "table", "label": _vm.$t("simplestats.visits.visitedpages") } })], 1)], 1);
  };
  ...
  __component__$a.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Sections/PageStats.vue";
  const PageStats = __component__$a.exports;
  const Devices_vue_vue_type_style_index_0_lang = "";
  const _sfc_main$9 = {
    extends: SectionBase,
    components: {
      AreaChart
  ...
  var _sfc_render$9 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("k-grid", { attrs: { "gutter": "medium" } }, [_c("k-column", { attrs: { "width": "1/3" } }, [_c("area-chart", { attrs: { "type": "Pie", "chart-data": _vm.devicesData, "chart-labels": _vm.devicesLabels, "download": "Site_Devices.png", "label": _vm.$t("simplestats.devices.graph.devices"), "fill": true, "auto-colorize": true, "height": 200 } })], 1), _c("k-column", { attrs: { "width": "1/3" } }, [_c("area-chart", { attrs: { "type": "Pie", "chart-data": _vm.browsersData, "chart-labels": _vm.browsersLabels, "download": "Site_BrowserEngines.png", "label": _vm.$t("simplestats.devices.graph.engines"), "fill": true, "auto-colorize": true, "height": 200 } })], 1), _c("k-column", { attrs: { "width": "1/3" } }, [_c("area-chart", { attrs: { "type": "Pie", "chart-data": _vm.systemsData, "chart-labels": _vm.systemsLabels, "download": "Site_OperatingSystems.png", "label": _vm.$t("simplestats.devices.graph.oses"), "fill": true, "auto-colorize": true, "height": 200 } })], 1), _c("k-column", { attrs: { "width": "1/1" } }, [_c("area-chart", { attrs: { "type": "Line", "chart-data": _vm.devicesOverTimeData, "chart-labels": _vm.chartPeriodLabels, "download": "Site_DevicesEvolution.png", "label": _vm.$t("simplestats.devices.graph.devicehistory"), "header-size": "large", "x-title": _vm.$t("simplestats.charts.time"), "y-title": _vm.$t("simplestats.devices.graph.devicehistory.y"), "stacked": true, "fill": true, "auto-colorize": true, "x-time-axis": true, "y-visits-axis": true, "height": 300 } })], 1)], 1);
  };
  ...
  __component__$9.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Sections/Devices.vue";
  const Devices = __component__$9.exports;
  const Referers_vue_vue_type_style_index_0_lang = "";
  const _sfc_main$8 = {
    extends: SectionBase,
    components: {
      AreaChart,
    ...
    methods: {
      loadData(response) {
        ...
        this.userLocale = window.panel.$language ? window.panel.$language.code : "";
      }
    }
  };
  var _sfc_render$8 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("k-grid", { attrs: { "gutter": "medium" } }, [_c("k-column", { attrs: { "width": "1/2" } }, [_vm.refererMediumData.length > 0 ? _c("area-chart", { attrs: { "type": "Pie", "chart-data": _vm.refererMediumData, "chart-labels": _vm.refererMediumLabels, "download": "Site_ReferrersByMedium.png", "label": _vm.$t("simplestats.referers.referersbymedium", "Referers by medium"), "fill": true, "auto-colorize": true, "height": 200 } }) : _vm._e()], 1), _c("k-column", { attrs: { "width": "1/2" } }, [_c("area-chart", { attrs: { "type": "Pie", "chart-data": _vm.refererDomainsData, "chart-labels": _vm.refererDomainsLabels, "download": "Site_ReferrersByDomain.png", "label": _vm.$t("simplestats.referers.referersbydomain", "Referers by domain"), "fill": true, "auto-colorize": true, "height": 200 } })], 1), _c("k-column", { attrs: { "width": "1/1" } }, [_c("area-chart", { attrs: { "type": "Line", "chart-data": _vm.referersByMediumOverTimeData, "chart-labels": _vm.chartPeriodLabels, "download": "Site_ReferersEvolution.png", "label": _vm.$t("simplestats.referers.referersovertime"), "y-title": _vm.$t("simplestats.charts.hitspermedium", "Hits per medium"), "stacked": true, "fill": true, "auto-colorize": true, "x-time-axis": true, "y-visits-axis": true, "height": 300 } })], 1), _c("k-column", { attrs: { "width": "1/1" } }, [_c("k-line-field")], 1), _c("k-column", { attrs: { "width": "1/1" } }, [_c("searchable-table", { attrs: { "rows": _vm.refererTableData, "columns": _vm.refererTableLabels, "label": _vm.$t("simplestats.referers.allreferers") } })], 1)], 1);
  };
  ...
  __component__$8.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Sections/Referers.vue";
  const Referers = __component__$8.exports;
  const DbInformation_vue_vue_type_style_index_0_lang = "";
  const _sfc_main$7 = {
    extends: "k-pages-section",
    data() {
      return {
    ...
    filters: {
      ...
      prettyBytes: function(num) {
        ...
        exponent = Math.min(Math.floor(Math.log(num) / Math.log(1e3)), units.length - 1);
        num = (num / Math.pow(1e3, exponent)).toFixed(2) * 1;
        unit = units[exponent];
        return (neg ? "-" : "") + num + " " + unit;
      }
    },
    ...
    methods: {
      load() {
        ...
        this.$api.get("simplestats/listdbinfo").then((response) => {
          this.isLoading = false;
        ...
        this.$api.get("simplestats/checkrequirements").then((response) => {
          this.isLoading = false;
      ...
      requestUpgrade(e) {
        ...
        if (this.unlockUpgrade) {
          ...
          this.updateMessage = null;
          this.$api.get("simplestats/dbupgrade").then((response) => {
  ...
  var _sfc_render$7 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", { staticClass: "dbinformation" }, [_c("k-headline", { attrs: { "size": "large" } }, [_vm._v(_vm._s(_vm.$t("simplestats.info.title")))]), _c("k-headline", [_vm._v(_vm._s(_vm.$t("simplestats.info.db.title")))]), _c("k-text-field", { attrs: { "name": "", "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.db.file"), "value": _vm.databaseLocation, "icon": "file-zip" } }), _c("k-text-field", { attrs: { "name": "", "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.db.size"), "value": _vm._f("prettyBytes")(_vm.databaseSize), "icon": "download" } }), _c("k-number-field", { attrs: { "name": "", "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.db.dbversion"), "value": _vm.dbVersion, "icon": "bolt" } }), _c("k-number-field", { attrs: { "name": "", "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.db.softwareversion"), "value": _vm.softwareDbVersion, "icon": "bolt" } }), _c("br"), _c("br"), _c("searchable-table", { attrs: { "rows": _vm.dbHistory, "columns": _vm.dbHistoryLabels, "label": _vm.$t("simplestats.info.db.versionhistory") } }), _c("k-line-field"), _c("k-headline", [_vm._v(_vm._s(_vm.$t("simplestats.info.dbreqs.title")))]), _vm.dbRequirementsPassed ? _c("div", [_c("k-info-field", { attrs: { "theme": "positive", "text": _vm.$t("simplestats.info.dbreqs.positive") } })], 1) : _c("div", [_c("k-info-field", { attrs: { "theme": "negative", "text": _vm.$t("simplestats.info.dbreqs.negative") } }), _c("hr"), _vm._v(" " + _vm._s(_vm.dbRequirements) + " ")], 1), _c("br"), _c("div", { staticClass: "upgrade" }, [_c("br"), _c("br"), _vm.upgradeRequired ? _c("div", [!_vm.updateMessage ? _c("div", [_c("k-info-field", { attrs: { "label": _vm.$t("simplestats.info.dbupdate.required"), "theme": "negative", "text": _vm.$t("simplestats.info.dbupdate.requiredmsg") } }), _c("br"), _c("k-checkbox-input", { attrs: { "value": _vm.unlockUpgrade, "label": _vm.$t("simplestats.info.dbupdate.isbackedup") }, on: { "input": _vm.acceptUpgrade } }), _c("br"), _c("k-button", { attrs: { "icon": "bolt" }, on: { "click": _vm.requestUpgrade } }, [_vm._v(_vm._s(_vm.$t("simplestats.info.dbupdate.go")))]), _vm.isUpdatingDb ? _c("k-label", [_vm._v(_vm._s(_vm.$t("simplestats.loading")))]) : _vm._e()], 1) : _c("div", [_c("k-info-field", { attrs: { "label": _vm.$t("simplestats.info.dbupdate.result"), "text": _vm.updateMessage, "theme": _vm.updateMessageTheme } }), _c("k-button", { attrs: { "theme": "neutral" }, on: { "click": _vm.load } }, [_vm._v(_vm._s(_vm.$t("simplestats.info.dbupdate.refresh")))])], 1)]) : _vm.updateMessage == null ? _c("div", [_c("k-info-field", { attrs: { "label": _vm.$t("simplestats.info.dbupdate.title"), "text": _vm.$t("simplestats.info.dbupdate.isuptodate"), "theme": "positive" } })], 1) : _vm.updateMessage !== null ? _c("div", [_c("k-info-field", { attrs: { "label": _vm.$t("simplestats.loaderror"), "text": _vm.updateMessage, "theme": "negative" } })], 1) : _vm._e()])], 1);
  };
  ...
  __component__$7.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Sections/DbInformation.vue";
  const DbInformation = __component__$7.exports;
  const Configuration_vue_vue_type_style_index_0_lang = "";
  const _sfc_main$6 = {
    extends: SectionBase,
    data() {
      return {
    ...
    computed: {
      trackingFeatures() {
        var features = [];
        if (this.enableReferers)
          features.push(this.$t("simplestats.info.config.tracking.referrers", "Referers"));
        if (this.enableDevices)
          features.push(this.$t("simplestats.info.config.tracking.devices", "Devices"));
        if (this.enableVisits)
          features.push(this.$t("simplestats.info.config.tracking.visits", "Page Visits"));
        if (this.enableVisitLanguages)
          features.push(this.$t("simplestats.info.config.tracking.languages", "Page Visitors"));
        return features;
      }
    },
    methods: {
  ...
  var _sfc_render$6 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", { staticClass: "configuration" }, [_c("k-headline", { attrs: { "size": "large" } }, [_vm._v(_vm._s(_vm.$t("simplestats.info.config.title")))]), _c("k-headline", { staticClass: "rightColumnAlign" }, [_vm._v(_vm._s(_vm.$t("simplestats.info.config.tracking")))]), _c("k-text-field", { attrs: { "name": "", "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.config.tracking.periodname"), "value": _vm.trackingPeriodName, "icon": "clock" } }), _c("k-number-field", { attrs: { "name": "", "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.config.tracking.periodsecs"), "value": _vm.uniqueSeconds, "after": _vm.$t("simplestats.charts.seconds"), "icon": "clock" } }), _c("k-toggle-field", { attrs: { "name": "", "disabled": true, "label": _vm.$t("simplestats.info.config.tracking.salted"), "value": _vm.saltIsSet, "icon": "key" } }), _c("k-tags-field", { attrs: { "name": "", "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.config.tracking.features"), "value": _vm.trackingFeatures, "icon": "globe" } }), _c("k-tags-field", { attrs: { "name": "", "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.config.tracking.ignore.roles"), "value": _vm.ignoredRoles, "icon": "users" } }), _c("k-tags-field", { attrs: { "name": "", "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.config.tracking.ignore.ids"), "value": _vm.ignoredPages, "icon": "page" } }), _c("k-tags-field", { attrs: { "name": "", "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.config.tracking.ignore.templates"), "value": _vm.ignoredTemplates, "icon": "page" } }), _c("br"), _c("k-headline", { staticClass: "rightColumnAlign" }, [_vm._v(_vm._s(_vm.$t("simplestats.info.config.log.title")))]), _c("k-text-field", { attrs: { "name": "", "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.config.log.file"), "value": _vm.logFile, "icon": "file-code" } }), _c("k-tags-field", { attrs: { "name": "", "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.config.log.level"), "value": _vm.logLevels, "icon": "bug" } }), _c("br"), !_vm.isLoading && !_vm.saltIsSet ? _c("k-info-field", { attrs: { "label": _vm.$t("simplestats.info.config.tracking.unsalted"), "theme": "negative", "text": _vm.$t("simplestats.info.config.tracking.unsaltedwarn") } }) : _vm._e()], 1);
  };
  ...
  __component__$6.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Sections/Configuration.vue";
  const Configuration = __component__$6.exports;
  const ListViewer_vue_vue_type_style_index_0_lang = "";
  const _sfc_main$5 = {
    name: "list-viewer",
    // Needed for self-recursiveness
    props: {
      "arrayData": {
        type: Array,
        default: []
  ...
  var _sfc_render$5 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", [_vm.arrayData ? _c("ul", { style: { paddingLeft: 20 * _vm.depth + "px" } }, _vm._l(_vm.arrayData, function(value, key, index2) {
      return _c("li", _vm._b({ key, class: { isChild: _vm.subpage, "text-danger": _vm.hasError } }, "li", _vm.arrayData.status, false), [typeof value === "Array" || typeof value === "object" ? _c("div", [_c("span", [_vm._v(" " + _vm._s(key) + " = ")]), (typeof value === "Array" || typeof value === "object") && _vm.depth < 10 ? _c("list-viewer", { attrs: { "array-data": value, "depth": _vm.depth + 1 } }) : _vm._e()], 1) : _c("div", [_c("span", [_vm._v(" " + _vm._s(key) + " = " + _vm._s(value) + " ")])])]);
    }), 0) : _vm._e()]);
  };
  ...
  __component__$5.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Sections/ListViewer.vue";
  const ListViewer = __component__$5.exports;
  const TrackingTester_vue_vue_type_style_index_0_lang = "";
  const _sfc_main$4 = {
    name: "TrackingTester",
    //extends: 'k-pages-section',
    components: {
    ...
    data() {
      ...
      let before = /* @__PURE__ */ new Date();
      before.setDate(now2.getDate() - 30);
      return {
        isLoading: true,
        error: "",
        currentDevice: "",
    ...
    computed: {
      ...
      formattedReferrerUrl() {
        if (this.referrerResponse) {
          if (this.referrerResponse.url)
            return this.referrerResponse.url;
          else if (this.referrerResponse.error)
            return this.referrerResponse.error;
        }
        return "-none-";
      ...
      formattedReferrerSource() {
        if (this.referrerResponse) {
          if (this.referrerResponse.source)
            return this.referrerResponse.source;
          else if (this.referrerResponse.error)
            return this.referrerResponse.error;
        }
        return "-none-";
      ...
      formattedReferrerHost() {
        if (this.referrerResponse) {
          if (this.referrerResponse.host)
            return this.referrerResponse.host;
          else if (this.referrerResponse.error)
            return this.referrerResponse.error;
        }
        return "-none-";
      ...
      formattedReferrerMedium() {
        if (this.referrerResponse) {
          if (this.referrerResponse.medium)
            return this.referrerResponse.medium;
          else if (this.referrerResponse.error)
            return this.referrerResponse.error;
        }
        return "-none-";
    ...
    methods: {
      load() {
        this.$api.get("simplestats/trackingtester").then((response) => {
          this.isLoading = false;
      ...
      testReferrer() {
        this.$api.get("simplestats/trackingtester/referrer?referrer=" + encodeURIComponent(this.referrerField)).then((response) => {
          if (response && typeof response.referrerInfo == "string")
            this.referrerResponse = {
              error: response.referrerInfo
            };
          else if (response && typeof response.referrerInfo == "object")
            this.referrerResponse = response.referrerInfo;
          else
            this.referrerResponse = {
          ...
          if (error && error.message)
            this.referrerResponse = error.message;
          else
            this.referrerResponse = "Loading error !";
        });
      },
      testUserAgent() {
        this.$api.get("simplestats/trackingtester/ua?ua=" + encodeURIComponent(this.customUserAgent)).then((response) => {
          if (typeof response == "string")
            this.customDevice = {
              error: response
            };
          else if (typeof response == "object")
            this.customDevice = response;
          else
            this.customDevice = {
              error: "Data format error !"
            };
          ...
          if (error && error.message)
            this.customDevice = error.message;
          else
            this.customDevice = "Loading Error !";
        });
      },
      acceptGenerate(v) {
      ...
      generateStats() {
        this.$api.get("simplestats/trackingtester/generatestats?proceed=" + (this.unlockGenerator ? "yes" : "no") + "&from=" + new Date(this.generatorFrom).getTime() * 1e-3 + "&to=" + new Date(this.generatorTo).getTime() * 1e-3 + "&mode=" + this.generatorMode).then((response) => {
  ...
  var _sfc_render$4 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("k-grid", { staticClass: "trackingtester", attrs: { "gutter": "large" } }, [_c("k-column", { attrs: { "width": "1/1" } }, [_c("k-headline", { attrs: { "size": "large" } }, [_vm._v(_vm._s(_vm.$t("simplestats.info.tester.title")))])], 1), _c("k-column", { attrs: { "width": "1/2" } }, [_c("k-headline", { staticClass: "rightColumnAlign" }, [_vm._v(_vm._s(_vm.$t("simplestats.info.tester.device")))]), _c("k-text-field", { attrs: { "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.tester.device.currentua"), "value": _vm.currentUserAgent, "icon": "display" } }), _c("k-text-field", { attrs: { "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.tester.device.currentdetected"), "value": _vm.formattedCurrentUA, "icon": "display" } }), _c("k-form", { on: { "submit": _vm.testUserAgent } }, [_c("k-text-field", { staticClass: "field-with-btn", attrs: { "counter": false, "disabled": false, "label": _vm.$t("simplestats.info.tester.device.customua"), "icon": "display" }, model: { value: _vm.customUserAgent, callback: function($$v) {
      _vm.customUserAgent = $$v;
    }, expression: "customUserAgent" } }), _c("k-button", { staticClass: "floating-btn", on: { "click": _vm.testUserAgent } }, [_vm._v("Go!")]), this.customDevice ? _c("k-text-field", { attrs: { "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.tester.device.customdetected"), "value": _vm.formattedCustomUA, "icon": "display" } }) : _vm._e()], 1), this.customDevice ? _c("k-box", { attrs: { "theme": "info", "text": _vm.$t("simplestats.info.tester.device.note") } }) : _vm._e()], 1), _c("k-column", { attrs: { "width": "1/2" } }, [_c("k-headline", { staticClass: "rightColumnAlign" }, [_vm._v(_vm._s(_vm.$t("simplestats.info.tester.generator")))]), _c("k-form", { on: { "submit": _vm.generateStats } }, [_c("k-select-field", { attrs: { "label": _vm.$t("simplestats.info.tester.generator.generatorMode"), "options": [
      { value: "all", text: "Static : all pages" },
      { value: "randomsingle", text: "Single random page" },
      { value: "randommulti", text: "Multiple random pages" }
    ] }, model: { value: _vm.generatorMode, callback: function($$v) {
      _vm.generatorMode = $$v;
    }, expression: "generatorMode" } }), _c("k-date-field", { attrs: { "label": _vm.$t("simplestats.info.tester.generator.datefrom"), "time": false }, model: { value: _vm.generatorFrom, callback: function($$v) {
      _vm.generatorFrom = $$v;
    }, expression: "generatorFrom" } }), _c("k-date-field", { attrs: { "label": _vm.$t("simplestats.info.tester.generator.dateto"), "time": false }, model: { value: _vm.generatorTo, callback: function($$v) {
      _vm.generatorTo = $$v;
    }, expression: "generatorTo" } }), _c("k-field", { attrs: { "translate": false, "label": _vm.$t("simplestats.info.tester.generator.unlockgenerator") } }, [_c("k-checkbox-input", { style: { padding: ".5em" }, attrs: { "value": _vm.unlockGenerator, "theme": "field", "novalidate": true }, on: { "input": _vm.acceptGenerate } }), _c("k-button", { style: { border: "1px solid black", padding: "0 1em", "borderRadius": "3px" }, on: { "click": _vm.generateStats } }, [_vm._v("Go!")])], 1), _vm.generatorResponse && _vm.generatorResponse.data ? _c("k-field", { attrs: { "translate": false, "label": "Result" } }, [_c("list-viewer", { staticClass: "k-input", style: { padding: "1em" }, attrs: { "array-data": _vm.generatorResponse.data, "data-theme": "field" } })], 1) : _vm._e(), _vm.generatorResponse && _vm.generatorResponse.error ? _c("k-textarea-field", { attrs: { "label": "Error!", "buttons": false, "disabled": true }, model: { value: _vm.generatorResponse.error, callback: function($$v) {
      _vm.$set(_vm.generatorResponse, "error", $$v);
    }, expression: "generatorResponse.error" } }) : _vm._e()], 1)], 1), _c("k-column", { attrs: { "width": "1/2" } }, [_c("k-headline", { staticClass: "rightColumnAlign" }, [_vm._v(_vm._s(_vm.$t("simplestats.info.tester.referrer")))]), _c("k-form", { on: { "submit": _vm.testReferrer } }, [_c("k-text-field", { staticClass: "field-with-btn", attrs: { "counter": false, "disabled": false, "label": _vm.$t("simplestats.info.tester.referrer.field"), "icon": "globe" }, model: { value: _vm.referrerField, callback: function($$v) {
      _vm.referrerField = $$v;
    }, expression: "referrerField" } }), _c("k-button", { staticClass: "floating-btn", attrs: { "name": "btn" }, on: { "click": _vm.testReferrer } }, [_vm._v("Go!")]), this.referrerResponse ? _c("k-text-field", { attrs: { "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.tester.referrer.response.host"), "value": _vm.formattedReferrerHost, "icon": "globe" } }) : _vm._e(), this.referrerResponse ? _c("k-text-field", { attrs: { "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.tester.referrer.response.source"), "value": _vm.formattedReferrerSource, "icon": "globe" } }) : _vm._e(), this.referrerResponse ? _c("k-text-field", { attrs: { "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.tester.referrer.response.medium"), "value": _vm.formattedReferrerMedium, "icon": "globe" } }) : _vm._e(), this.referrerResponse ? _c("k-text-field", { attrs: { "counter": false, "disabled": true, "label": _vm.$t("simplestats.info.tester.referrer.response.url"), "value": _vm.formattedReferrerUrl, "icon": "globe" } }) : _vm._e()], 1)], 1)], 1);
  };
  ...
  __component__$4.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Sections/TrackingTester.vue";
  const TrackingTester = __component__$4.exports;
  ...
  (function(module2, exports) {
    (function(global2, factory) {
      ...
      function scope(target, options, originalOptions) {
        ...
        function attachEvent(events2, element, callback2, data) {
  ...
  const noUiSlider = /* @__PURE__ */ getDefaultExportFromCjs(nouislider.exports);
  ...
  var veeno = {
    ...
    props: {
      ...
      pipsy: {
        ...
        validator: function(value) {
          return typeof value === "boolean" || !Array.isArray(value) && typeof value === "object";
        }
      },
      rtl: {
        type: Boolean,
      ...
      behaviour: {
        ...
        default: "tap",
        validator: function(value) {
          return ["drag", "tap", "fixed", "snap", "none"].indexOf(value !== -1);
        }
      },
      getset: {
        type: Function,
    ...
    mounted: function mounted() {
      ...
      events.forEach(function(event) {
        slider.noUiSlider.on(event, function(values, handle, unencoded, tap, positions2) {
          this$1$1.$emit(event, { values, handle, unencoded, tap, positions: positions2 });
          event === "update" && this$1$1.$emit("input", values);
        });
      });
      this.getset(slider);
    },
  ...
  const TimeFrameInput_vue_vue_type_style_index_0_lang = "";
  const _sfc_main$3 = {
    components: {
      // Slider,
      "slider-fixed": {
        ...
        mounted() {
          ...
          if (this.$props.fixedpips) {
            (_b = (_a = this.$el) == null ? void 0 : _a.noUiSlider) == null ? void 0 : _b.updateOptions({ pips: this.$props.fixedpips }, false);
          }
        }
      }
    },
    ...
    methods: {
      ...
      updateDateFields(fromto) {
        ...
        if (!Array.isArray(fromto) || fromto.length !== 2)
          return;
        for (let i = 0; i < 2; i++) {
          const target = i === 0 ? "dateFrom" : "dateTo";
          const value = fromto[i];
          ...
          if (this[target].length && this.dateChoices) {
            ...
            (_a = this.$refs[i === 0 ? "calendarFromDrawer" : "calendarToDrawer"]) == null ? void 0 : _a.close();
          }
          (_d = (_c = (_b = this.$refs.slider) == null ? void 0 : _b.$el) == null ? void 0 : _c.noUiSlider) == null ? void 0 : _d.set([fromto[0] ? this.dateFrom : null, fromto[1] ? this.dateTo : null], false, false);
        }
      },
  ...
  var _sfc_render$3 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("k-grid", { staticClass: "ss-timeframe-input", attrs: { "gutter": "medium" } }, [_c("k-column", { attrs: { "width": "3/12" } }, [_c("k-field", _vm._b({ staticClass: "k-date-field", attrs: { "input": _vm._uid } }, "k-field", _vm.$props, false), [_c("div", { staticClass: "k-date-field-body", attrs: { "data-theme": "field" } }, [_c("k-input", { ref: "fromDateField", attrs: { "autofocus": false, "display": _vm.staticDateFieldProps.display, "min": _vm.minDate, "max": _vm.maxDate, "required": true, "theme": "field", "type": "date", "icon": "calendar", "before": _vm.$t("simplestats.timeframe.date.from", "From") }, scopedSlots: _vm._u([{ key: "icon", fn: function() {
      return [_c("k-dropdown", [_c("k-button", { staticClass: "k-input-icon-button", attrs: { "icon": "calendar", "tooltip": _vm.$t("date.select") }, on: { "click": function($event) {
        return _vm.$refs.calendarFromDrawer.toggle();
      } } }), _c("k-dropdown-content", { ref: "calendarFromDrawer", attrs: { "align": "right" } }, [_c("k-calendar", { ref: "calendarFrom", attrs: { "value": _vm.dateFrom + " 00:00:00", "min": _vm.minDate, "max": _vm.maxDate }, on: { "input": _vm.onUpdateKirbyDateFrom } })], 1)], 1)];
    }, proxy: true }]), model: { value: _vm.dateFrom, callback: function($$v) {
      _vm.dateFrom = $$v;
    }, expression: "dateFrom" } })], 1)])], 1), _c("k-column", { attrs: { "width": "6/12" } }, [_c("div", { staticClass: "k-range-input ss-timeframe-range" }, [_c("slider-fixed", { ref: "slider", attrs: { "handles": _vm.timeFrame, "set": _vm.timeFrame, "range": _vm.sliderRange, "behaviour": "drag", "connect": "", "step": 1, "tooltips": _vm.sliderDateTooltipsFunc, "format": _vm.sliderDateFormatter, "fixedpips": _vm.sliderStepSettings }, on: { "update": _vm.onSliderUpdate, "change": _vm.onSliderChange, "set": _vm.onSliderSet } })], 1)]), _c("k-column", { attrs: { "width": "3/12" } }, [_c("k-field", _vm._b({ staticClass: "k-date-field", attrs: { "input": _vm._uid } }, "k-field", _vm.$props, false), [_c("div", { staticClass: "k-date-field-body", attrs: { "data-theme": "field" } }, [_c("k-input", { ref: "toDateField", attrs: { "autofocus": false, "display": _vm.staticDateFieldProps.display, "min": _vm.minDate, "max": _vm.maxDate, "required": true, "theme": "field", "type": "date", "icon": "calendar", "before": _vm.$t("simplestats.timeframe.date.to", "To") }, scopedSlots: _vm._u([{ key: "icon", fn: function() {
      return [_c("k-dropdown", [_c("k-button", { staticClass: "k-input-icon-button", attrs: { "icon": "calendar", "tooltip": _vm.$t("date.select") }, on: { "click": function($event) {
        return _vm.$refs.calendarToDrawer.toggle();
      } } }), _c("k-dropdown-content", { ref: "calendarToDrawer", attrs: { "align": "right" } }, [_c("k-calendar", { ref: "calendarTo", attrs: { "value": _vm.dateTo + " 00:00:00", "min": _vm.minDate, "max": _vm.maxDate }, on: { "input": _vm.onUpdateKirbyDateTo } })], 1)], 1)];
    }, proxy: true }]), model: { value: _vm.dateTo, callback: function($$v) {
      _vm.dateTo = $$v;
    }, expression: "dateTo" } })], 1)])], 1)], 1);
  };
  ...
  __component__$3.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Ui/TimeFrameInput.vue";
  const TimeFrameInput = __component__$3.exports;
  const SimpleStatsArea_vue_vue_type_style_index_0_lang = "";
  const _sfc_main$2 = {
    components: {
      Visitors,
      PageStats,
    ...
    methods: {
      ...
      onTab(tab) {
        ...
        if (!mTab || mTab.length < 1 && this.initialtab)
          mTab = this.initialtab;
        if (!this.tabs.some((aTab) => aTab.name === mTab)) {
          mTab = this.tabs[0].name;
        }
        this.tab = mTab;
        this.$root.$view.breadcrumb[0].label = (_b = (_a = this.tabs.find((t) => t.name === tab)) == null ? void 0 : _a.label) != null ? _b : mTab;
  ...
  var _sfc_render$2 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("k-inside", [_c("k-view", { staticClass: "k-simplestats-view" }, [!_vm.isLoading && !_vm.dismissDisclaimer ? _c("k-grid", [_c("k-column", [_c("k-headline", { attrs: { "size": "medium", "align": "center" } }, [_vm._v(_vm._s(_vm.$t("simplestats.disclaimer.title")))]), _c("k-text", { attrs: { "size": "small", "align": "center" } }, [_c("span", { domProps: { "innerHTML": _vm._s(_vm.$t("simplestats.disclaimer.text")) } }), _c("span", { staticClass: "hover-to-help" }, [_c("k-icon", { attrs: { "type": "question" } }), _c("div", { staticClass: "help" }, [_c("k-text", { attrs: { "theme": "help", "size": "small", "align": "center" } }, [_vm._v(_vm._s(_vm.$t("simplestats.disclaimer.dismiss")))])], 1)], 1), _c("br")]), _c("br"), _c("br")], 1)], 1) : _vm._e(), _c("k-header", { attrs: { "tabs": _vm.tabs, "tab": _vm.tab }, on: { "tabChange": _vm.onTab } }, [_c("template", { slot: "default" }, [_vm._v(" " + _vm._s(_vm.label) + " ")]), _c("template", { slot: "right" }, [_c("time-frame-input", { ref: "timeFrame", attrs: { "dateChoices": _vm.timeframes } })], 1)], 2), _vm.tab == _vm.tabs[0].name ? _c("div", [_c("page-stats", { attrs: { "dateFrom": _vm.$refs.timeFrame.dateFrom, "dateTo": _vm.$refs.timeFrame.dateTo, "section-name": "pagestats" } })], 1) : _vm.tab == _vm.tabs[1].name ? _c("div", [_c("devices", { attrs: { "dateFrom": _vm.$refs.timeFrame.dateFrom, "dateTo": _vm.$refs.timeFrame.dateTo, "section-name": "devicestats" } })], 1) : _vm.tab == _vm.tabs[2].name ? _c("div", [_c("referers", { attrs: { "dateFrom": _vm.$refs.timeFrame.dateFrom, "dateTo": _vm.$refs.timeFrame.dateTo, "section-name": "refererstats" } })], 1) : _vm.tab == _vm.tabs[3].name ? _c("div", [_c("k-grid", { attrs: { "gutter": "large" } }, [_c("k-column", { attrs: { "width": "1/2" } }, [_c("configuration", { attrs: { "section-name": "configinfo" } })], 1), _c("k-column", { attrs: { "width": "1/2" } }, [_c("DbInformation", { attrs: { "section-name": "listdbinfo" } })], 1), _c("k-column", { attrs: { "width": "1/1" } }, [_c("k-line-field"), _c("tracking-tester")], 1), _c("k-column", { attrs: { "width": "1/1" } }, [_c("k-line-field"), _c("visitors", { attrs: { "section-name": "listvisitors" } })], 1)], 1)], 1) : _c("div", [_c("k-empty", [_vm._v(_vm._s(_vm.$t("simplestats.taberror")))])], 1)], 1)], 1);
  };
  ...
  __component__$2.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/SimpleStatsArea.vue";
  const SimpleStatsArea = __component__$2.exports;
  const OnePageStats_vue_vue_type_style_index_0_lang = "";
  const _sfc_main$1 = {
    //extends: 'k-pages-section',
    data() {
      return {
    ...
    */
    computed: {
      ...
      sectionSize() {
        if (this.size == "small" || this.size == "compact")
          return "small";
        else if (this.size == "medium" || this.size == "normal")
          return "medium";
        else if (this.size == "large" || this.size == "huge")
          return "large";
      ...
      chartOptions() {
        return {
          ...
          tooltips: {
            //enabled: false,
            position: "nearest",
            // places tooltip on points in x-mode
            //mode: 'dataset',
            mode: "x",
            // Tooltip sends all item on x axis, so we can sum them up
            callbacks: {
    ...
    created() {
      this.load().then((response) => {
        var _a;
        this.label = (_a = response.label) != null ? _a : response.headline;
    ...
    methods: {
      ...
      pieLabel(tooltipItem, data) {
        ...
        var total = dataset.data.reduce(function(previousValue, currentValue2, currentIndex, array) {
  ...
  var _sfc_render$1 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", { class: { "simplestatsonepagedetailssection": true, "small": _vm.sectionSize == "small", "medium": _vm.sectionSize == "medium", "large": _vm.sectionSize == "large" } }, [_vm.label ? _c("div", [_c("k-headline", { attrs: { "size": "medium" } }, [_c("k-icon", { staticStyle: { "display": "inline-block", "padding-right": "0.5rem" }, attrs: { "type": "chart", "size": "tiny" } }), _vm._v(" " + _vm._s(_vm.label))], 1), _c("br")], 1) : _vm._e(), _vm.showFullInfo && _vm.showTotals ? _c("p", [_vm._v(" This page has been "), _c("strong", [_vm._v("visited " + _vm._s(_vm.totalHits) + " times")]), _vm._v(" since " + _vm._s(_vm.trackedSince) + " and was last visited on " + _vm._s(_vm.lastVisited) + " which averages to "), _c("strong", [_vm._v(_vm._s(Math.round(_vm.averageHits)) + " visits per " + _vm._s(_vm.timespanUnitName))]), _vm._v(" using " + _vm._s(_vm.trackingPeriods) + " samples. ")]) : _vm.showTotals ? _c("p", [_vm._v(" Total hits: "), _c("strong", [_vm._v(_vm._s(_vm.totalHits))]), _vm._v(" ("), _c("strong", [_vm._v(_vm._s(Math.round(_vm.averageHits)))]), _vm._v(" per " + _vm._s(_vm.timespanUnitName) + ") ")]) : _vm._e(), _vm.showTotals ? _c("k-line-field") : _vm._e(), _vm.languagesAreEnabled && _vm.showTimeline ? _c("div", { staticClass: "detailcolumn visitsovertime" }, [_c("k-headline", { attrs: { "size": "medium" } }, [_vm._v(_vm._s(_vm.$t("simplestats.visits.visitsovertime")))]), _vm.languagesOverTime.length > 0 ? _c("area-chart", { attrs: { "data": _vm.languagesOverTime, "download": true, "download": "PageLanguagesOverTime.png", "xtitle": _vm.$t("simplestats.charts.time"), "ytitle": _vm.$t("simplestats.charts.visits"), "height": this.sectionSize == "small" ? "240px" : this.sectionSize == "large" ? "280px" : this.sectionSize == "tiny" ? "120px" : "260px", "stacked": true, "library": _vm.chartOptions } }) : _c("k-empty", { staticClass: "emptyChart", attrs: { "layout": "block" } }, [_vm._v(_vm._s(_vm.$t("simplestats.nodatayet")))])], 1) : _vm.showTimeline ? _c("div", { staticClass: "detailcolumn visitsovertime" }, [_c("br"), _c("k-headline", { attrs: { "size": "medium" } }, [_vm._v(_vm._s(_vm.$t("simplestats.visits.languagesovertime")))]), _vm.visitsOverTime.length > 0 ? _c("area-chart", { attrs: { "data": _vm.visitsOverTime, "download": true, "download": "PageVisitsOverTime.png", "xtitle": _vm.$t("simplestats.charts.time"), "ytitle": _vm.$t("simplestats.charts.visits"), "height": this.sectionSize == "small" ? "240px" : this.sectionSize == "large" ? "280px" : this.sectionSize == "tiny" ? "120px" : "260px", "library": _vm.chartOptions } }) : _c("k-empty", { staticClass: "emptyChart", attrs: { "layout": "block" } }, [_vm._v(_vm._s(_vm.$t("simplestats.nodatayet")))])], 1) : _vm._e(), _vm.languagesAreEnabled && _vm.showLanguages ? _c("div", { staticClass: "detailcolumn globallanguages" }, [_c("k-headline", [_vm._v(_vm._s(_vm.$t("simplestats.visits.globallanguages")))]), _vm.languageTotalHits.length > 0 ? _c("pie-chart", { attrs: { "data": _vm.languageTotalHits, "height": this.sectionSize == "small" ? "185px" : this.sectionSize == "large" ? "225px" : this.sectionSize == "tiny" ? "80px" : "205px", "library": _vm.pieOptions } }) : _c("k-empty", { staticClass: "emptyChart", attrs: { "layout": "block" } }, [_vm._v(_vm._s(_vm.$t("simplestats.nodatayet")))])], 1) : _vm._e()], 1);
  };
  ...
  __component__$1.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Sections/OnePageStats.vue";
  const OnePageStats = __component__$1.exports;
  const PercentagePreview_vue_vue_type_style_index_0_lang = "";
  const _sfc_main = {
    props: {
      value: String | Number,
      column: Object,
  ...
  var _sfc_render = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("p", { staticClass: "ss-percentage-field-preview" }, [_c("span", { staticClass: "ss-progress", style: "width: " + _vm.percentage + "%;" }, [_vm._v(_vm._s(_vm.percentage) + "%")])]);
  };
  ...
  __component__.options.__file = "/Users/philipkuban/Sites/visionbites/protokirby-v3/custom-plugins/kirby3-simplestats/src/components/Ui/PercentagePreview.vue";
  const PercentageFieldPreview = __component__.exports;
          ...
          bindTabClicks() {
            ...
            for (const child of this.$children) {
              if (child.$el.classList.contains("k-tab-button")) {
                child.$el.addEventListener("click", function() {
                  thisRef.onClick(child.$vnode.key);
                });
              }
            }
          },
